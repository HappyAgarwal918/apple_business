   ...
   <div class="container text-center" style="justify-content: space-around;">
    ...
    font-size: 40px; font-weight: 600; line-height: 48px; margin: 0;">Business Submitted</h2>
           <h1 class="thankyoutext">Thank you!</h1>
            <p>Your business will be added to the <br class="d-none d-md-block">Apple Business Directory within 72 hours.<br class="d-none d-md-block"> If we need any additional information, <br class="d-none d-md-block">a representative will be contacting you.</p> 
